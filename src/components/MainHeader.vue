...
export default {
  ...
  mounted() {
    // Inicializar el store y establecer un watcher
...
<template>
  <div>
    <div class="nav-container">
      ...
      <nav v-if="!$isAuthenticated" class="header-right">
        <a href="form-lost-animal">Crear publicación</a>
        <a class="button-login" href="/login">Acceder</a>
        <a class="button-register" href="/register">Registrarse</a>
